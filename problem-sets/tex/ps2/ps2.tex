...
\hypersetup
{
    ...
    pdfsubject={An Economic Geography Model of COVID-19},
    colorlinks = {true},
    linkcolor = {FireBrick},
    citecolor = {FireBrick},
    urlcolor = {RoyalBlue},
...
\begin{enumerate}
    \item Write a function that takes three inputs, the elasticity $\sigma$, a vector of values for $K$ and a vector of values for $L$. The function should distinguish the three four different cases \eqref{eqn:ces_function}, \eqref{eqn:linear}, \eqref{eqn:cobb_douglas}, \eqref{eqn:leontief}.
